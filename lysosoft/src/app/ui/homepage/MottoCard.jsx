...
const MottoCard = ({title,author}) => {
  return (
    <div className='relative rounded-2xl p-5 flex flex-col gap-2 justify-between min-h-56 h-fit opacity-85 hover:opacity-100 w-fit bg-[url("/images/commonBlur.png")] overflow-hidden bg-no-repeat bg-cover z-30'>
